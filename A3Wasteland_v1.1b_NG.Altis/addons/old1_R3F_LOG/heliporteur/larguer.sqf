...
else
{
	...
	private ["_heliporteur", "_objet", "_airdrop"]; //Cael817, added "_airdrop" from LouDnl
	
	_heliporteur = _this select 0;
	_objet = _heliporteur getVariable "R3F_LOG_heliporte";
	_parachute = [_this, 3, false, [false]] call BIS_fnc_param; //Cael817, from LouDnl
	...
	//Cael817, added line 32-51 from LouDnl
	if (_parachute) then
	{
